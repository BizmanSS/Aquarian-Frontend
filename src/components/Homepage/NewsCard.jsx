...
const NewsCard = ({ data }) => {
  return (
    <a href={data.path}>
      <div className="relative min-w-[20rem] max-w-[23rem] hover:bg-[#E2E7EC] cursor-pointer h-[31rem] overflow-hidden bg-[#EDF1F6] rounded-lg shadow-xl py-4 px-2 transition ease-in delay-40 duration-200">
        <img
