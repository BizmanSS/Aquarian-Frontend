...
const CrsForm = () => {
  ...
  const calculateScore = () => {
    ...
    if ((answers[1] === "M" || answers[1] === "CL") && answers[5] === "yes") {
      ...
      switch (
        answers[10] //spouse language
      ) {
        case "IELTS": {
          secC +=
            (scoreMap[10][answers[10.11]] ?? 0) +
            (scoreMap[10][answers[10.12]] ?? 0) +
            (scoreMap[10][answers[10.13]] ?? 0) +
            (scoreMap[10][answers[10.14]] ?? 0);
          break;
        }
        case "PTE": {
          secC +=
            (scoreMap[10][answers[10.21]] ?? 0) +
            (scoreMap[10][answers[10.22]] ?? 0) +
            (scoreMap[10][answers[10.23]] ?? 0) +
            (scoreMap[10][answers[10.24]] ?? 0);
          break;
        }
        case "CEL": {
          secC +=
            (scoreMap[10][answers[10.31]] ?? 0) +
            (scoreMap[10][answers[10.32]] ?? 0) +
            (scoreMap[10][answers[10.33]] ?? 0) +
            (scoreMap[10][answers[10.34]] ?? 0);
          break;
        }
        case "TEF": {
          secC +=
            (scoreMap[10][answers[10.41]] ?? 0) +
            (scoreMap[10][answers[10.42]] ?? 0) +
            (scoreMap[10][answers[10.43]] ?? 0) +
            (scoreMap[10][answers[10.44]] ?? 0);
          break;
        }
        case "TCF": {
          secC +=
            (scoreMap[10][answers[10.51]] ?? 0) +
            (scoreMap[10][answers[10.52]] ?? 0) +
            (scoreMap[10][answers[10.53]] ?? 0) +
            (scoreMap[10][answers[10.54]] ?? 0);
          break;
        }
      }
    ...
    secA +=
      scoreMap[eng][ClbLang[eng]["R"]] +
      scoreMap[eng][ClbLang[eng]["W"]] +
      scoreMap[eng][ClbLang[eng]["L"]] +
      scoreMap[eng][ClbLang[eng]["S"]];
    ...
    secA +=
      scoreMap[fr][ClbLang[fr]["R"]] +
      scoreMap[fr][ClbLang[fr]["W"]] +
      scoreMap[fr][ClbLang[fr]["L"]] +
      scoreMap[fr][ClbLang[fr]["S"]];
    ...
    if (answers[8] === "B") {
      //skill 2 and 4 - case 2
      secD += secDScore.Sk_Case2[answers[3]] ?? 0;
      secD += secDScore.Sk34_Case2[answers[12]] ?? 0;
    } else if (answers[8] && answers[8] !== "Default" && answers[8] !== "A") {
      // skill 2 and 4- case 1
      secD += secDScore.Sk_Case1[answers[3]] ?? 0;
      secD += secDScore.Sk34_Case1[answers[12]] ?? 0;
    }
  ...
  const handleChange = (id, value, name = "") => {
    ...
    const currentQuestionIndex = questionConfig.findIndex(
      (q) => q.id.toString() === id
    );
        ...
        <div className="crs-form-container">
          ...
          {showFinalScore && (
            <div>
              ...
              <div className="crs-final-score-display">
                Your Final CRS Score: {score}
              </div>
            </div>
          )}
        </div>
