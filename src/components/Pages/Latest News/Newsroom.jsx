...
const newsArticles = [
  ...
  { 
    id: 5, 
    date: "11 June, 2024", 
    title: "Helpful advice for newcomers landing in Canada: A post-arrival checklist", 
    imgSrc: Canada_E, 
...
export default function Newsroom() {
  ...
  const handlenewsreadmore = (index) => {
    setSelectedNewsIndex(index); // Set selected index to show detail view
  };
    ...
    <div className="newsroom-container">
            ...
            <div className="recent-news">
              <div className="news-left-image">
                ...
                <div className="newsroom_info">
                  ...
                  <p>
                    Canada boasts top universities known for academic excellence and research. The University of Toronto, McGill University, and University of British Columbia lead the list, offering diverse programs and vibrant campus life. Other notable institutions include the University of Alberta, University of Calgary, and Queen's University, each known for their unique strengths.
                  </p>
                  <a href="#" className="news-read-more" onClick={() => handlenewsreadmore(0)}>Read More&gt;&gt;</a>
                </div>
              </div>
            ...
            <div className="news-feature-bar">
              ...
              <div className="newsroomgrid-container">
                {newsArticles.map((article, index) => (
                  <div className="news-grid-item" key={article.id} onClick={() => handlenewsreadmore(index)}>
      ...
      <button className="Allnews-button" onClick={handlenavigateallnews}>
        ...
        <div className="newsDetailContainer">
          ...
          <h3 className="newsTitleDetail">{newsArticles[selectedNewsIndex].title}</h3>
          <p className="newsDate">{newsArticles[selectedNewsIndex].date}</p>
          <img src={newsArticles[selectedNewsIndex].imgSrc} alt={newsArticles[selectedNewsIndex].title} />
          <p className="newsContentDetail">{newsArticles[selectedNewsIndex].description}</p>
          <button className="backToNewsButton" onClick={() => setSelectedNewsIndex(null)}>Back to News</button>
        </div>
      )}
    </div>
  );
