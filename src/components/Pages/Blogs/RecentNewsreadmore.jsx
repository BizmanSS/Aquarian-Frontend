  ...
  return (
    ...
    <p className='aq-news-date'>Sunday , 1 Jan 2024</p>
      ...
      <div className='readmore-news-content'>
        ...
        <h1>2. University of British Columbia (UBC)</h1>
        ...
        <h1>6. University of Montreal</h1>
