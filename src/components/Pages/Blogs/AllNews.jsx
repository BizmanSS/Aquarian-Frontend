    ...
    <div className="all-news-container">
      ...
      {selectedNewsIndex !== null ? (
        <div className="newsDetailContainer">
         ...
         <div className="BTN_BOX"> <p className="BTN">{filteredNewsData[selectedNewsIndex].button} </p>
         <p className="BTN">{filteredNewsData[selectedNewsIndex].button2} </p></div>
            ...
            <div className="AllNews-news-grid">
              {currentNews.map((news, index) => (
                <div className="AllNews-news-card" key={news.id}>
                  ...
                  <div className="BTN_BOX"> <p className="BTN_CARDS">{news.button}</p>                    <p className="BTN_CARDS">{news.button2}</p></div> 
