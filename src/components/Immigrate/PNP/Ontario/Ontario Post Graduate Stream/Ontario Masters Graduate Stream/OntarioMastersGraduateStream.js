...
const Table = () => {
  const data = [
    ...
    { requirement: "Language Proficiency", value: "CLB 7" },
    { requirement: "Level of Education", value: "Master's Degree" },
...
export default function OntarioMasterGraduateStream() {
  return (
    <div
      style={{
        background: "#E0E0E0",
    ...
    >
      <div className="AboutUsHeader">
        <p className="link">
          ...
          {" > "}Ontario Master Graduate Stream
        </p>
        <div className="header-content">
          <h1 className="heading-about">Ontario Master Graduate Stream</h1>
        </div>
      </div>
      <h2 className="pages-content-div">
        The Master’s Graduate stream targets foreign nationals who have recently
        completed a Master’s Degree from an eligible educational institution in
        Ontario and who have the intention of living and working in Ontario.
        Candidates who are successfully nominated through the Ontario Masters
        Graduate Stream will be invited to submit an official application for
        ...
        <br />
        <br />
        In order to qualify for the Ontario Masters Graduate stream, candidates
        must demonstrate past residency in Ontario. Successful applicants must
        show that they have resided in Ontario for at least 12 out of the 24
        ...
        <br />
        <br />
        All candidates for the Ontario Masters Graduate stream must meet the
        ...
        <br />
        <br />
        <sp>Ontario Masters Graduate Ranking System</sp>
        <br />
        <br />
        <TableFactor />
        <br />
