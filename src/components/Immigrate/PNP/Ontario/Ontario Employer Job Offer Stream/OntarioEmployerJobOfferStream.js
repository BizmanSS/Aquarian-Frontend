      ...
      <div className="pages-content-wrapper">
        ...
        <div class="pages-content-div">
          <div class="pages-content-text-wrapper ">
            ...
            ref={(el) => {
              ForeignRef.current= el;
              sectionRefs.current['Ontario Foreign Worker'] = el;
            }}
            >
            ...
            <div class="pages-header-2"
            ref={(el) => {
              InternationalRef.current= el;
              sectionRefs.current['Ontario International Student'] = el;
            }}
            >
            ...
            <div class="pages-header-2" 
            ref={(el) => {
              InDemandRef.current= el;
              sectionRefs.current['Ontario In-Demand Stream'] = el;
            }}
            >
