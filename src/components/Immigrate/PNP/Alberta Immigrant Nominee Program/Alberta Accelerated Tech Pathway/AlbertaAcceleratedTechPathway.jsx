    ...
    >
      <div className="pages-content-wrapper">
        <SiteMapMenu
          ...
          h3="Alberta Accelerated Tech Pathway"
        ></SiteMapMenu>
        ...
        <div class="pages-content-div">
          <div class="pages-content-text-wrapper ">
            ...
            <div className="pages-paragraph">
              Create and maintain an active Express Entry profile, ensuring that
              your primary occupation aligns with the eligible NOC codes for
              tech professionals.
              <ul className="my-2 ml-3">
                <li>
                  Submit a formal application through Alberta’s online portal,
                  including proof of your job offer and eligibility documents.
                </li>

                <li>
                  If your application is successful, you will receive a
                  provincial nomination from Alberta. This will add 600 points
                  to your Comprehensive Ranking System (CRS) score in Express
                  Entry, virtually guaranteeing an Invitation to Apply (ITA) for
                  permanent residency.
                </li>

                <li>
                  With the provincial nomination in hand, submit your PR
                  application to Immigration, Refugees, and Citizenship Canada
                  (IRCC). Processing time typically ranges from 4 to 6 months.
                </li>
              </ul>
              In 2023, Alberta saw record growth in tech investments, with over
              $700 million in venture capital funding directed towards tech
              companies. The Accelerated Tech Pathway is a reflection of this
              growth and Alberta's need for skilled professionals to support its
              tech-driven economy. Eligible candidates submit their Express
              Entry profile, job offer, and employer details to the AAIP.
              Alberta assesses the application and invites eligible candidates
              to apply for nomination. PNP applications under this pathway are
              processed faster. Successful nominees receive 600 CRS points,
              increasing their chance of an ITA for permanent residence.
            </div>
          </div>
