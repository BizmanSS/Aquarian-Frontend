  ...
  useEffect(() => {
    if (currentPageRef.current && menuRef.current) {
      ...
      const scrollPosition =
        elementTopPosition - containerHeight / 2 + elementHeight / 2;
                  ...
                  {item.nestedLinks?.map((subItem) => (
                    <>
                      <div className="site-map-sub-header">
                        <a
                          ref={
                            props.h2 === subItem.title ? currentPageRef : null
                          } // Attach ref to the current h2 title
                          className={`site-map-sub-link ${
                            !props.h3 && props.h2 === subItem.title
                              ? "site-map-current-page"
                              : ""
                          }`}
                          href={subItem.linkTo}
                          ...
                          {subItem.nested?.map((subsubItem) => (
                            <>
                              <div className="site-map-ss-header">
                                <a
                                  ref={
                                    !props.h4 && props.h3 === subsubItem.title
                                      ? currentPageRef
                                      : null
                                  } // Attach ref to the current h3 title
